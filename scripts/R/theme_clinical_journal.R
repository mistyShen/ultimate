ultimate_style_registry <- function() {
  list(
    soft_color = list(style_id = "clinical_journal_v3_soft_color", style_cn = "临床期刊版-柔彩科研配色", text = "#3B4354", axis = "#667085", grid = "#ECEFF4", primary = "#6C7BEF", secondary = "#5EC4B6", case = "#E36A6A", control = "#4A90D9", accent = "#D8A24A", neutral = "#BAC3D0", bar = "#5FAFC1", bar_light = "#D8E7EC", bar_highlight = "#E36A6A", heatmap_low = "#5DA9C7", heatmap_mid = "#F8FAFC", heatmap_high = "#D96C75"),

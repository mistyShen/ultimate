...
TOOL_REGISTRY: tuple[ToolSpec, ...] = (
    ...
    _tool("LIANA", "https://github.com/saezlab/liana-py", "communication", "keep_optional", "specialized_light", env="ultimate-scrna", python_import="liana", install_method="pip>=1.7.3 validated without numpy/numba downgrade", size_class="medium", reason_cn="整合多通讯方法；已验证可在 ultimate-scrna 作为开源通信 backend。"),

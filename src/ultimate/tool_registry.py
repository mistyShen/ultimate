...
TOOL_REGISTRY: tuple[ToolSpec, ...] = (
    ...
    _tool("dyno", "https://github.com/dynverse/dyno", "trajectory", "keep_optional", "specialized_heavy", env="ultimate-scrna-r", r_package="dyno", size_class="xlarge", reason_cn="轨迹方法集合，重依赖，按需。"),
    ...
    _tool("pycisTopic", "https://github.com/aertslab/pycisTopic", "scatac", "keep_optional", "specialized_heavy", env="ultimate-scatac-py", python_import="pycisTopic", size_class="large", reason_cn="topic/motif 调控分析候选。"),
    _tool("pycistarget", "https://github.com/aertslab/pycistarget", "scatac", "keep_optional", "specialized_heavy", env="ultimate-scatac-py", python_import="pycistarget", size_class="large", reason_cn="motif target enrichment 候选。"),
    ...
    _tool("MiXCR", "https://github.com/milaboratory/mixcr", "vdj", "keep_optional", "upstream_adapter", env="ultimate-vdj", command="mixcr", size_class="large", reason_cn="VDJ 上游组装/注释。"),
    _tool("tcrdist3", "https://github.com/kmayerb/tcrdist3", "vdj", "keep_optional", "specialized_light", env="ultimate-vdj", python_import="tcrdist", size_class="medium", reason_cn="TCR 距离和相似性分析。"),
    ...
    _tool("Giotto", "https://github.com/giottosuite/Giotto", "spatial", "keep_optional", "specialized_heavy", env="ultimate-spatial-r", r_package="Giotto", size_class="large", reason_cn="R 空间生态候选。"),
    ...
    _tool("Vitessce", "https://github.com/vitessce/vitessce", "visualization", "keep_optional", "visualization", env="ultimate-workflow", size_class="large", reason_cn="空间/多模态交互交付。"),
    _tool("easy-vitessce", "https://github.com/vitessce/easy-vitessce", "visualization", "keep_optional", "visualization", env="ultimate-workflow", python_import="vitessce", size_class="medium", reason_cn="Vitessce 配置生成。"),
    _tool("STdeconvolve", "https://github.com/JEFworks-Lab/STdeconvolve", "spatial", "keep_optional", "specialized_light", env="ultimate-spatial-r", r_package="STdeconvolve", size_class="medium", reason_cn="空间解卷积候选。"),
    ...
    _tool("spacexr", "https://github.com/dmcable/spacexr", "spatial", "keep_optional", "specialized_light", env="ultimate-spatial-r", r_package="spacexr", size_class="medium", reason_cn="RCTD 空间解卷积候选。"),
    _tool("BayesSpace", "https://github.com/edward130603/BayesSpace", "spatial", "keep_optional", "specialized_light", env="ultimate-spatial-r", r_package="BayesSpace", size_class="medium", reason_cn="空间 domain 聚类候选。"),
    # Tumor and genome.
    ...
    _tool("HoneyBADGER", "https://github.com/JEFworks-Lab/HoneyBADGER", "tumor_sc", "keep_optional", "specialized_heavy", env="ultimate-scrna-r", r_package="HoneyBADGER", size_class="large", reason_cn="CNV/LOH 候选，低频。"),
    _tool("ASCAT", "https://github.com/VanLoo-lab/ascat", "genome", "keep_optional", "genome_tools", env="ultimate-genome-mtdna", r_package="ascat", size_class="medium", reason_cn="bulk tumor-normal CNV purity/ploidy 参考。"),
    ...
    _tool("MissionBio mosaic", "https://github.com/MissionBio/mosaic", "scdna", "keep_optional", "genome_tools", env="ultimate-genome-mtdna", python_import="mosaic", size_class="large", reason_cn="MissionBio 单细胞 DNA 数据候选。"),
    ...
    _tool("SingleCellMultiOmics", "https://github.com/BuysDB/SingleCellMultiOmics", "genome", "keep_optional", "genome_tools", env="ultimate-genome-mtdna", python_import="singlecellmultiomics", size_class="large", reason_cn="单细胞多组学/mtDNA/genotyping 候选。"),
    _tool("MitoTrace", "https://github.com/LareauCA/MitoTrace", "mtdna", "keep_optional", "genome_tools", env="ultimate-genome-mtdna", install_method="R/Python project", size_class="medium", reason_cn="mtDNA lineage tracing 候选。"),
    ...
    _tool("mitoClone2", "https://github.com/caleblareau/mitoClone2", "mtdna", "keep_optional", "genome_tools", env="ultimate-genome-mtdna", r_package="mitoClone2", install_method="R remotes", size_class="medium", reason_cn="mtDNA 克隆分析候选。"),
    ...
    _tool("demuxlet", "https://github.com/statgen/demuxlet", "genotype", "keep_optional", "genome_tools", env="ultimate-genome-mtdna", command="demuxlet", size_class="medium", reason_cn="有 genotype 时 demultiplex。"),
    _tool("popscle", "https://github.com/statgen/popscle", "genotype", "keep_optional", "genome_tools", env="ultimate-genome-mtdna", command="popscle", size_class="medium", reason_cn="demuxlet 相关工具集。"),
    # Visualization and formats.
    _tool("Dash", "https://github.com/plotly/dash", "visualization", "keep_optional", "visualization", env="ultimate-workflow", python_import="dash", size_class="medium", reason_cn="客户交互 dashboard 候选。"),
